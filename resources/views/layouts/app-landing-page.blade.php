...
<body>
    ...
    <div class="navbar bg-base-100 sticky top-0 z-50">
        ...
        <div class="navbar-center hidden lg:flex">
            <ul class="menu menu-horizontal px-1 text-green-700">
                <li>
                    <a>Tentang</a>
                </li>
                <li>
                    <a href="{{ route('index.showCampaign') }}">Campaign</a>
                </li>
                <li>
                    <a>Contact</a>
                </li>
        ...
        <div class="navbar-end">
            <span>
                <a href="{{ route('index.showCampaign') }}" class="btn btn-success text-white">Donasi</a>
            </span>
        </div>
    </div>
    {{-- End Navbar --}}
    ...
    {{-- End Main Section --}}
        {{-- Footer Section --}}
        <footer class="footer footer-center bg-base-200 text-base-content rounded p-10 bg-green-400 text-white">
            ...
            <aside>
                <p>Copyright © {{ now()->year }} - All right reserved by Fahmi Ilmawan</p>
            </aside>
        </footer>
        {{-- End Footer Section --}}
